...
const Cover = () => {
  return (
    <div className="w-full lg:w-11/12 flex flex-row justify-between gap-10 md:gap-20 relative overflow-hidden bg-neutral-700 pl-7 md:pl-14 pt-3 md:pt-6 rounded-xl">
      ...
      <span className="text-neutral-600 text-4xl font-semibold -rotate-45 absolute top-1/3 right-[45%] z-10 animate-opacityHidden hidden lg:block">
        Web
      </span>
      <span className="text-neutral-600 text-3xl font-semibold rotate-12 absolute top-10 right-[48%] z-10 animate-opacityHidden hidden lg:block">
        EF Core
      </span>
      ...
      <span className="text-neutral-600 text-6xl font-semibold absolute top-1/2 right-[40%] z-10 animate-opacityHidden hidden lg:block">
        C#
      </span>
      <span className="text-neutral-600 text-5xl font-semibold absolute top-32 right-[52%] z-10 animate-opacityHidden hidden lg:block">
        React
      </span>
      <span className="text-neutral-600 text-6xl font-semibold -rotate-12 absolute top-20 right-1/3 z-10 animate-opacityHidden hidden lg:block">
        .Net
      </span>
      <span className="text-neutral-600 text-4xl font-semibold rotate-12 absolute bottom-20 right-[40%] z-10 animate-opacityHidden hidden lg:block">
        TypeScript
      </span>
      <span className="text-neutral-600 text-3xl font-semibold -rotate-12 absolute bottom-16 right-[58%] z-10 animate-opacityHidden hidden lg:block">
        Docker
      </span>
